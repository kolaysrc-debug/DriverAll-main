...
// PATH: drivercv-frontend/app/advertiser/ad-requests/page.tsx
// ----------------------------------------------------------
// Advertiser Ad Requests — modern kart tabanlı tasarım
// ----------------------------------------------------------
      ...
      <div className="mx-auto max-w-6xl px-4 py-5 md:px-8 space-y-4">
        ...
        <div className="rounded-2xl border border-slate-800 bg-gradient-to-r from-slate-900 to-slate-950 p-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              <h1 className="text-lg font-bold text-slate-50">Reklam Taleplerim</h1>
              <p className="text-xs text-slate-400 mt-0.5">Tüm reklam taleplerinizi ve durumlarını takip edin</p>
            </div>
            <div className="flex items-center gap-2">
              ...
              <Link href="/advertiser/ad-requests/new" className="rounded-lg bg-emerald-600 px-4 py-2 text-xs font-medium text-white hover:bg-emerald-500 transition-colors">+ Yeni Talep</Link>
        ...
        {!loading && list.length === 0 && (
          <div className="rounded-2xl border border-dashed border-slate-700 bg-slate-900/30 p-8 text-center">
            ...
            <div className="text-slate-400 text-sm">Henüz reklam talebi göndermediniz.</div>
            <Link href="/advertiser/ad-requests/new" className="mt-3 inline-block rounded-lg bg-emerald-600 px-5 py-2 text-sm font-medium text-white hover:bg-emerald-500 transition-colors">
              İlk Talebi Oluştur
            </Link>
          </div>
        )}
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-sm font-semibold text-slate-100 truncate">
                          {r.adTitle || r.title || "Reklam Talebi"}
                        </span>
                      ...
                      <div className="mt-1 flex items-center gap-3 text-xs text-slate-400 flex-wrap">
                        {r.packageName && <span>📦 {r.packageName}</span>}
