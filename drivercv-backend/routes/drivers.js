...
// NOT: Şimdilik bu endpoint'leri extra auth ile kilitlemedik.
// Production ortamında mutlaka admin rol kontrolü eklenmeli.
...
router.put("/:id", async (req, res) => {
  try {
    const allowed = ["name", "email", "role", "isActive", "isApproved", "notes"];
    const updates = {};
