// PATH: DriverAll-main/drivercv-backend/services/otp/engine.js
...
async function checkOtp({ country, phoneE164, code }) {
  ...
  // Verify check does not require channel selection; but some providers do.
  // We'll try all active twilioVerify providers across channels.
  const tried = [];
